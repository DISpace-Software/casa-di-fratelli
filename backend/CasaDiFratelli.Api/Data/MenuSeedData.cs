...
public static class MenuSeedData
{
    ...
    private static readonly SeedMenuItem[] Items =
    {
        ...
        new("pizza", "Капричоза", "Capricciosa", "Доматен сос, моцарела, маслини каламата, артишок, кото и гъби", "Tomato sauce, mozzarella, Kalamata olives, artichoke, cotto, and mushrooms", "500 гр", 20.36m),
        ...
        new("pizza", "Джорджио", "Giorgio", "Моцарела, кото, шамфъстък, песто, бурата, босилек и лимонови кори", "Mozzarella, cotto, pistachio, pesto, burrata, basil, and lemon zest", "500 гр", 24.27m),
