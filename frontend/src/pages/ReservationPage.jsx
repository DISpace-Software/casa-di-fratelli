...
function GardenMap({ tables, selectedIds, onSelect, labels }) {
  ...
  return (
    <div className="reservation-map-surface garden-map relative min-h-[360px] overflow-hidden rounded-[24px] border border-white/10 bg-[radial-gradient(circle_at_top,_rgba(60,169,126,0.13),_transparent_34%),linear-gradient(180deg,rgba(34,40,28,0.96),rgba(16,18,13,0.96))] shadow-inner sm:aspect-[1.6/1] sm:min-h-0">
      ...
      <MapWindow className="bottom-3 left-5 right-5 h-4" label="" />
      <div className="pointer-events-none absolute left-1/2 top-3 z-10 -translate-x-1/2 -translate-y-1/2">
        <div className="relative h-6 w-16 rounded-lg border border-white/18 bg-[#080706] shadow-[0_0_24px_rgba(0,0,0,0.42)]">
          <div className="absolute inset-1 rounded-lg bg-[linear-gradient(160deg,rgba(56,189,248,0.28),rgba(255,255,255,0.08)_42%,rgba(20,184,166,0.16))]" />
        </div>
        <div className="absolute left-1/2 top-full mt-1 -translate-x-1/2 whitespace-nowrap rounded-full border border-white/10 bg-black/30 px-2 py-1 text-[7px] font-bold uppercase tracking-[0.16em] text-white/60">{labels.tv}</div>
      </div>
      <div className="pointer-events-none absolute left-0 top-1/2 z-10 w-[150px] -translate-x-1/2 -translate-y-1/2 -rotate-90 text-center">
...
function IndoorMap({ tables, selectedIds, onSelect, labels }) {
  const rotatedTables = tables.map((table) => ({
    source: table,
    display: { ...table, ...rotatePercentPointCounterClockwise(table) },
  }));
  ...
  return (
    <div className="reservation-map-surface indoor-map relative min-h-[560px] overflow-hidden rounded-[24px] border border-white/10 bg-[radial-gradient(circle_at_top,_rgba(201,165,106,0.16),_transparent_34%),radial-gradient(circle_at_18%_60%,rgba(125,211,252,0.08),transparent_25%),linear-gradient(180deg,rgba(39,27,21,0.96),rgba(16,12,10,0.96))] sm:aspect-[1.6/1] sm:min-h-0">
      <div className="map-grid absolute inset-5 rounded-[22px] border border-[#c9a56a]/14 bg-[linear-gradient(90deg,rgba(255,255,255,0.025)_1px,transparent_1px),linear-gradient(180deg,rgba(255,255,255,0.025)_1px,transparent_1px)] bg-[length:42px_42px]" />
      <MapWindow className="bottom-3 left-5 h-4 w-[50%]" label={labels.windows} />
      <MapWindow className="bottom-3 left-[70%] right-5 h-4" label={labels.windows} />
      <div className="pointer-events-none absolute bottom-0 left-[60%] z-10 w-[120px] -translate-x-1/2 text-center">
